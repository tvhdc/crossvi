...
**[Download v1.0.0](https://github.com/tvhdc/crossvi/releases/download/v1.0.0/firmware.bin) ·
...
- **New X4 units:** Some revisions require a
  ...
  to remain powered without USB. CrossVi 1.0.0 includes that behavior, but it
